...
exports.programmaticToolCallingTool = programmaticToolCallingTool;
...
function codeInterpreterTool(options = {}) {
    const allowedCallers = (0, internal_1.normalizeToolAllowedCallers)(options.allowedCallers, options.name ?? 'code_interpreter');
    const providerData = {
 ...
 */
function programmaticToolCallingTool() {
    return {
        type: 'hosted_tool',
