...
import {
  assertHederaFacilitatorSupport,
  buildCalibrationRoutes,
  buildStrictHbarPaymentPolicy,
  createPaidCalibrationRequester,
  HBAR_ASSET,
  HEDERA_TESTNET,
  MAX_HBAR_PRICE_TINYBAR,
  parseHbarPriceTinybar,
} from "../src/x402.js";
...
function supportedResponse(overrides: Partial<SupportedResponse> = {}): SupportedResponse {
  return {
    kinds: [{
      x402Version: 2,
      scheme: "exact",
